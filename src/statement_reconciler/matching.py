...
class Result:
    ...
    #: green on a document nobody actually read.
    warnings: tuple[str, ...] = ()
    ...
    def reconciled(self) -> bool:
        ...
        and nothing that makes the comparison untrustworthy in the first place.
        ...
        same way: the pairing behind it was a guess. So does a warning.
        """
        return (
            not self.unmatched
